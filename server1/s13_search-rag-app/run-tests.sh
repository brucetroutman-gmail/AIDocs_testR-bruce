...
#    export LOGGER="inputs"
     ...
     export PC_CODE="btm164"
     fi                                                                                 # .(50513.02.9 End)

#    export ENVs="1"                                                                    # .(50513.05.19)
...
#    export DRYRUN="0"                          # .(50506.03.1 RAM Add DRYRUN)
            ...
            bEnvs=${ENVs}                                                               # .(50513.05.20)
    if [ "${bEnvs}" == "1" ]; then echo "  - S1300[  33]  APP: '${APP}', DOIT: '${DOIT}',  DEBUG: '${DEBUG}', DRYRUN: '${DRYRUN}', SCORING: '${SCORING}', PC_CODE: '${PC_CODE}', LOGGER: '${LOGGER}'"; fi # exit  # .(50513.05.21)
